            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Perbandingan sesi selesai, ditinggalkan, dan berlangsung</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
...
am5.ready(function() {
    ...
    var statusData = [
        ...
        { category: "Ditinggalkan", value: {{ $sessionStatusData['abandoned'] ?? 0 }}, fill: am5.color("#F1416C") },
        { category: "Berlangsung", value: {{ $sessionStatusData['in_progress'] ?? 0 }}, fill: am5.color("#FFC700") }
    ];
