    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    <a href="{{ route('psychologist.teachers.create') }}" class="btn btn-primary">
        ...
        <div class="card-body pt-0">
            <div id="teachersTableContainer">
                @include('psychologist.teachers.partials.table')
            </div>
        </div>
        <!--end::Card body-->
    </div>
...
<script>
    let searchTimeout;
    const searchUrl = '{{ route("psychologist.teachers.index") }}';
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit', '.delete-form', function(e) {
            e.preventDefault();
            const form = $(this);
            const teacherId = form.data('teacher-id');
    ...
    function performSearch(searchValue) {
        $.ajax({
            ...
            success: function(response) {
                $('#teachersTableContainer').html(response.html);
