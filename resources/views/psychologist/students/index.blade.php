...
<li class="breadcrumb-item text-gray-500">Data Siswa</li>
@endsection
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end gap-2">
                    <select id="classFilter" class="form-select form-select-solid w-200px">
                    ...
                    <a href="{{ route('psychologist.students.create') }}" class="btn btn-primary">
        ...
        <div class="card-body pt-0">
            <div id="studentsTableContainer">
                @include('psychologist.students.partials.table')
            </div>
        </div>
        <!--end::Card body-->
    </div>
...
<script>
    let searchTimeout;
    const searchUrl = '{{ route("psychologist.students.index") }}';
