    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <!-- Search Bar -->
                <form method="GET" action="{{ $class ? url('/teacher/classes/' . $class->id . '/students') : route('teacher.students.index') }}" class="flex-1">
                    @if(request('sort_by'))
                    ...
                    <div class="relative">
                        ...
                        @if(request('search'))
                            <a href="{{ $class ? url('/teacher/classes/' . $class->id . '/students') . (request('sort_by') ? '?sort_by=' . request('sort_by') . '&sort_order=' . request('sort_order', 'asc') : '') : route('teacher.students.index') . (request('sort_by') ? '?sort_by=' . request('sort_by') . '&sort_order=' . request('sort_order', 'asc') : '') }}" 
