        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex-1 relative">
                    ...
                    <button type="button" id="clearSearch" class="absolute inset-y-0 right-0 pr-4 flex items-center hidden">
...
$(document).ready(function() {
    ...
    let searchTimeout;
    const searchUrl = '{{ $class ? url("/teacher/classes/" . $class->id . "/students") : route("teacher.students.index") }}';
