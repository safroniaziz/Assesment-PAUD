...
<!-- Create Modal -->
<div id="createModal" class="fixed inset-0 z-50 overflow-y-auto hidden opacity-0 transition-opacity duration-300 ease-out">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 modal-overlay transition-opacity duration-300"></div>
        
        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all duration-300 ease-out sm:my-8 sm:align-middle sm:max-w-lg sm:w-full scale-95 translate-y-4 sm:translate-y-0">
...
<!-- Edit Modal -->
<div id="editModal" class="fixed inset-0 z-50 overflow-y-auto hidden opacity-0 transition-opacity duration-300 ease-out">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 modal-overlay transition-opacity duration-300"></div>
...
$(document).ready(function() {
    ...
    function openModal(modalId) {
        ...
        setTimeout(() => {
            ...
            modalContent.removeClass('scale-95 translate-y-4 sm:translate-y-0').addClass('scale-100 translate-y-0');
        }, 10);
    }
    ...
    function closeModal(modalId) {
        ...
        modalContent.removeClass('scale-100 translate-y-0').addClass('scale-95 translate-y-4 sm:translate-y-0');
    ...
    $('.btn-close-modal, .modal-overlay').on('click', function(e) {
        ...
        if ($(e.target).closest('.inline-block').length) {
            return;
        }
        
        if ($('#createModal').hasClass('opacity-100')) {
            closeModal('#createModal');
        }
        if ($('#editModal').hasClass('opacity-100')) {
