...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100 overflow-hidden">
        ...
        <div class="relative z-10 p-8">
            ...
            <div class="flex items-start justify-between mb-6">
                <div class="flex-1">
                    ...
                    <div class="relative mb-5">
                        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 via-indigo-500 to-purple-600 rounded-2xl shadow-xl mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 relative">
                            <i class="fas fa-school text-white text-3xl"></i>
                            <div class="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
                    ...
                    <!-- Class Name -->
                    <h3 class="text-3xl font-extrabold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-indigo-600 transition-all duration-300">
                        {{ $class->name }}
                    </h3>

                    <!-- Academic Year Badge -->
                    <div class="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-50 rounded-xl border border-gray-200 shadow-sm group-hover:border-purple-200 group-hover:bg-gradient-to-r group-hover:from-purple-50 group-hover:to-indigo-50 transition-all duration-300">
                        <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center">
                            <i class="fas fa-calendar-alt text-white text-sm"></i>
                        </div>
                        <span class="font-bold text-gray-700 group-hover:text-purple-700 transition-colors">{{ $class->academic_year }}</span>
                    </div>
                </div>
            </div>

            <!-- Stats Card with Glassmorphism -->
            <div class="relative mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-700 shadow-2xl transform group-hover:scale-105 transition-all duration-300">
                ...
                <div class="relative p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <!-- Icon Container -->
                            <div class="relative">
                                <div class="w-16 h-16 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center shadow-lg border border-white/30">
                            ...
                            <!-- Stats Info -->
                            <div>
                                <p class="text-4xl font-extrabold text-white mb-1 drop-shadow-lg">{{ $class->students_count }}</p>
                                <div class="flex items-center space-x-2">
                                    <p class="text-sm text-white/90 font-semibold">Total Siswa</p>
                                    @if($class->students_count > 0)
                                    <span class="px-2 py-0.5 bg-white/20 backdrop-blur-sm rounded-full text-xs text-white font-bold border border-white/30">
                                        Aktif
                                    </span>
                                    @else
                                    <span class="px-2 py-0.5 bg-white/20 backdrop-blur-sm rounded-full text-xs text-white font-bold border border-white/30">
            ...
            <!-- Action Buttons -->
            <div class="flex items-center space-x-3 pt-6 border-t-2 border-gray-100 group-hover:border-purple-100 transition-colors">
                <a href="{{ route('teacher.students.index.class', $class) }}" class="flex-1 group/btn relative overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-5 py-3.5 rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 text-sm font-bold text-center shadow-lg hover:shadow-xl transform hover:scale-105">
