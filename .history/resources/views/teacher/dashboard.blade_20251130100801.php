...
@section('sidebar')
<nav class="space-y-2">
    <a href="{{ route('teacher.dashboard') }}" class="block px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg font-semibold shadow-md">
        <i class="fas fa-home mr-2"></i>Dashboard
    </a>
    <a href="{{ route('teacher.classes.index') }}" class="block px-4 py-2 hover:bg-purple-50 rounded-lg transition-colors">
        <i class="fas fa-school mr-2"></i>Kelola Kelas
    </a>
    <a href="{{ route('teacher.students.index') }}" class="block px-4 py-2 hover:bg-purple-50 rounded-lg transition-colors">
        <i class="fas fa-users mr-2"></i>Kelola Siswa
    </a>
    <a href="{{ route('teacher.results.index') }}" class="block px-4 py-2 hover:bg-purple-50 rounded-lg transition-colors">
        <i class="fas fa-chart-bar mr-2"></i>Hasil Asesmen
    </a>
    <a href="{{ route('game.select-class') }}" class="block px-4 py-2 hover:bg-purple-50 rounded-lg transition-colors" target="_blank">
        <i class="fas fa-gamepad mr-2"></i>Mulai Asesmen
    </a>
</nav>
@endsection
...
<div class="mb-8">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 text-lg">Kelola kelas dan pantau perkembangan siswa Anda</p>
        </div>
        <div class="hidden md:block">
            <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl p-6 text-white shadow-xl">
                ...
                <p class="text-3xl font-bold">{{ now()->format('d M Y') }}</p>
            </div>
        </div>
    </div>
</div>
