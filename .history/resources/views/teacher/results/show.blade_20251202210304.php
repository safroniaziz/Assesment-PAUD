                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            {{ $session->computed_total_score }} dari {{ $session->computed_total_questions }} soal benar
                                        </div>
                                        <div class="text-xs text-gray-500">
                                            total jawaban benar di sesi ini
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-bold text-purple-600">{{ $session->computed_max_score }}</div>
                                        <div class="text-xs text-gray-500">maks skor (jika semua soal dijawab benar)</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            @php
                                                // Ubah proporsi 0-1 menjadi persentase untuk kategori visual
                                                $avgPercent = $session->computed_avg_score * 100;
                                            @endphp
                                            @if($avgPercent >= 80)
                                                <div class="ml-2 flex items-center text-xs font-semibold text-green-600">
                                                    <i class="fas fa-arrow-up mr-1"></i>
                                                    <span>Tinggi</span>
                                                </div>
                                            @elseif($avgPercent >= 60)
                                                <div class="ml-2 flex items-center text-xs font-semibold text-yellow-600">
                                                    <i class="fas fa-minus mr-1"></i>
                                                    <span>Cukup</span>
                                                </div>
                                            @else
                                                <div class="ml-2 flex items-center text-xs font-semibold text-red-600">
                                    ...
                                    <td colspan="6" class="px-6 py-0">
                                        <div class="py-4 bg-gradient-to-r from-gray-50 to-blue-50">
                                            ...
                                            <p class="text-xs text-gray-500 mb-3">
                                                Setiap kartu menunjukkan <span class="font-semibold">rata-rata skor semua soal</span> di aspek tersebut pada sesi ini.
                                            </p>
