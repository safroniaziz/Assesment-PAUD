...
<div class="game-container h-screen flex flex-col p-3 md:p-4 relative overflow-hidden">
    ...
    <div class="flex-shrink-0 text-center relative z-10 mt-3">
        <button id="next-btn"
                disabled
                class="bg-gradient-to-r from-green-400 via-green-500 to-emerald-600 text-white px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg font-bold shadow-xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 active:scale-95 transition-all duration-300 transform relative overflow-hidden group w-full max-w-sm mx-auto whitespace-nowrap">
            <span class="relative z-10 flex items-center justify-center gap-2">
                <span>Lanjutkan</span>
                <i class="fas fa-arrow-right group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0"></i>
            </span>
