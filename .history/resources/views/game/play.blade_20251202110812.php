            ...
            <div class="grid grid-cols-2 gap-2.5 md:gap-4 flex-1 min-h-0 overflow-y-auto w-full" id="choices-container">
                @foreach($currentQuestion->choices as $index => $choice)
                    <button type="button" 
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-2 right-2 md:top-2 md:right-2 w-6 h-6 md:w-7 md:h-7 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 md:group-hover:opacity-100 transition-all duration-200 z-10 shadow-lg flex-shrink-0 selected-check">
                            <i class="fas fa-check text-xs"></i>
                        </div>
                        
                        <!-- Choice Image -->
                        <div class="flex-1 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-lg p-2 md:p-3 mb-2 md:mb-2 border border-gray-100 flex items-center justify-center overflow-hidden md:group-hover:shadow-sm transition-all duration-200 min-h-0 w-full choice-image-container">
                        ...
                        <div class="text-center flex-shrink-0 mt-auto">
                            <div class="inline-flex items-center justify-center bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 text-white rounded-full w-7 h-7 md:w-8 md:h-8 font-bold text-xs md:text-sm shadow-md md:group-hover:scale-110 transition-transform duration-200 flex-shrink-0 choice-badge">
                                {{ $index + 1 }}
                            </div>
                        </div>
                    </button>
