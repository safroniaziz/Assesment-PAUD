...
<div class="game-container h-screen flex flex-col p-3 md:p-4 relative overflow-hidden">
    ...
    <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 overflow-y-auto relative z-10 min-h-0">
        <!-- Left: Question Image -->
        <div class="flex items-center justify-center min-h-0 w-full">
            <div class="bg-white rounded-xl p-4 md:p-5 shadow-xl w-full h-full flex flex-col border-2 border-gray-200 relative overflow-hidden min-h-0 max-w-full">
                <!-- Decorative Corner -->
                ...
                <div class="text-center mb-3 flex-shrink-0 relative z-10">
                    <div class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-xs md:text-sm font-bold shadow-md whitespace-nowrap">
                        <i class="fas fa-star flex-shrink-0"></i>
                        <span>Pilih jawaban yang benar!</span>
                    </div>
                </div>
                <div class="flex-1 flex items-center justify-center bg-gradient-to-br from-purple-50 via-indigo-50 to-pink-50 rounded-lg p-3 md:p-4 border border-purple-100 overflow-auto relative z-10 min-h-0 w-full">
        ...
        <div class="flex flex-col min-h-0 w-full">
            <div class="bg-white/95 backdrop-blur-lg rounded-xl p-3 md:p-4 shadow-lg mb-3 flex-shrink-0 border border-gray-200">
                <h3 class="text-center text-sm md:text-base font-bold text-gray-800 flex items-center justify-center gap-2 whitespace-nowrap">
                    <i class="fas fa-hand-pointer text-purple-600 flex-shrink-0"></i>
                    <span>Pilih Jawaban</span>
                </h3>
            </div>
            <div class="grid grid-cols-2 gap-3 md:gap-4 flex-1 min-h-0 overflow-y-auto w-full" id="choices-container">
                @foreach($currentQuestion->choices as $index => $choice)
                    <button type="button"
                            class="choice-button group bg-white rounded-xl p-3 md:p-4 shadow-lg cursor-pointer border-2 border-gray-200 hover:border-purple-400 transform hover:scale-105 transition-all duration-300 relative overflow-hidden flex flex-col w-full min-w-0"
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-2 right-2 w-6 h-6 md:w-7 md:h-7 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 shadow-lg flex-shrink-0">
                            <i class="fas fa-check text-xs"></i>
                        </div>

                        <!-- Choice Image -->
                        <div class="flex-1 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-lg p-2 md:p-3 mb-2 border border-gray-100 flex items-center justify-center overflow-hidden group-hover:shadow-md transition-shadow duration-300 min-h-0 w-full">
                        ...
                        <div class="text-center flex-shrink-0">
                            <div class="inline-flex items-center justify-center bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 text-white rounded-full w-7 h-7 md:w-8 md:h-8 font-bold text-xs md:text-sm shadow-md group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                                {{ $index + 1 }}
                            </div>
                        </div>
                    </button>
