...
$(document).ready(function() {
    ...
    $('.choice-button').on('click', function() {
        ...
        // Remove previous selection from ALL buttons first (force remove)
        $('.choice-button').removeClass('selected animate-pulse');

        // Force reflow to ensure CSS is reset
        $('.choice-button')[0]?.offsetHeight;
        ...
        // Add subtle animation to selected button only
        $clickedButton.addClass('animate-pulse');
        setTimeout(() => {
            $clickedButton.removeClass('animate-pulse');
        }, 500);
    });
