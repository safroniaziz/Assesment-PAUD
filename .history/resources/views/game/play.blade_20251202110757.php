...
.choice-button.selected {
    ...
    box-shadow: 0 10px 25px rgba(139, 92, 246, 0.4), 0 0 0 4px rgba(139, 92, 246, 0.1);
...
.choice-button.selected > div:last-child > div {
    background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%) !important;
