...
<div class="game-container h-screen flex flex-col p-3 md:p-4 relative overflow-hidden">
    ...
    <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 overflow-y-auto relative z-10 min-h-0">
        ...
        <div class="flex flex-col min-h-0">
            ...
            <div class="grid grid-cols-2 gap-3 md:gap-4 flex-1 min-h-0 overflow-y-auto" id="choices-container">
                @foreach($currentQuestion->choices as $index => $choice)
                    <button type="button"
                        ...
                        <!-- Choice Image -->
                        <div class="flex-1 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-lg p-2 md:p-3 mb-2 border border-gray-100 flex items-center justify-center overflow-hidden group-hover:shadow-md transition-shadow duration-300 min-h-0">
                            <img src="{{ asset('storage/' . $choice->choice_image_path) }}"
                                 ...
                                 class="w-full h-auto max-h-full object-contain rounded-md">
                        </div>
