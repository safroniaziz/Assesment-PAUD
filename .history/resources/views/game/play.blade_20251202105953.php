            ...
            <div class="bg-white/95 backdrop-blur-lg rounded-xl p-3 md:p-4 shadow-lg border border-gray-200">
                <div class="flex items-center justify-between gap-3 flex-wrap">
                    <div class="flex items-center gap-3 flex-shrink-0">
                        <div class="bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 rounded-xl w-10 h-10 md:w-12 md:h-12 flex items-center justify-center text-white text-base md:text-lg font-bold shadow-md flex-shrink-0">
                            {{ $progress + 1 }}
                        </div>
                    ...
                    <div class="flex-1 mx-2 md:mx-4 min-w-[150px]">
