...
<div class="game-container h-screen flex flex-col p-3 md:p-4 relative overflow-hidden">
    ...
    <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 overflow-y-auto relative z-10 min-h-0">
        ...
        <div class="flex items-center justify-center min-h-0">
            <div class="bg-white rounded-xl p-4 md:p-5 shadow-xl w-full h-full flex flex-col border-2 border-gray-200 relative overflow-hidden min-h-0">
                <!-- Decorative Corner -->
                ...
                <div class="flex-1 flex items-center justify-center bg-gradient-to-br from-purple-50 via-indigo-50 to-pink-50 rounded-lg p-3 md:p-4 border border-purple-100 overflow-auto relative z-10 min-h-0">
