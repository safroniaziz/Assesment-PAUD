...
<div class="game-container h-screen flex flex-col p-2 md:p-4 relative overflow-hidden safe-area-inset">
    <!-- Elegant Header with Progress -->
        <div class="flex-shrink-0 mb-2 md:mb-3 relative z-10">
            <div class="bg-white/98 backdrop-blur-lg rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-xl border border-orange-100">
                <!-- Mobile Layout -->
                <div class="md:hidden">
                    <div class="flex items-center justify-between mb-2.5 gap-2">
                        <div class="flex items-center gap-2.5 flex-shrink-0">
                        <div class="bg-gradient-to-br from-orange-400 via-amber-500 to-yellow-500 rounded-lg w-9 h-9 flex items-center justify-center text-white text-sm font-bold shadow-lg flex-shrink-0">
                            {{ $progress + 1 }}
                        </div>
                        ...
                        <div class="text-right flex-shrink-0">
                            <p class="text-xs font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500">
                                {{ round((($progress + 1) / $totalQuestions) * 100) }}%
                            </p>
                        </div>
                    </div>
                        <div class="bg-gray-100 rounded-full h-2.5 overflow-hidden shadow-inner">
                        <div class="bg-gradient-to-r from-orange-400 via-amber-500 to-yellow-500 h-full rounded-full transition-all duration-700 ease-out shadow-sm"
                ...
                <div class="hidden md:flex items-center justify-between gap-3 flex-wrap">
                    <div class="flex items-center gap-3 flex-shrink-0">
                        <div class="bg-gradient-to-br from-orange-400 via-amber-500 to-yellow-500 rounded-xl w-12 h-12 flex items-center justify-center text-white text-lg font-bold shadow-lg flex-shrink-0">
                            {{ $progress + 1 }}
                        </div>
                        <div class="flex-shrink-0">
                    ...
                    <div class="text-right flex-shrink-0">
                        ...
                        <p class="text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500">
                            {{ round((($progress + 1) / $totalQuestions) * 100) }}%
                        </p>
                    </div>
                </div>
...
.choice-button.selected {
    ...
    box-shadow: 0 12px 30px rgba(245, 158, 11, 0.45), 0 0 0 4px rgba(245, 158, 11, 0.2);
