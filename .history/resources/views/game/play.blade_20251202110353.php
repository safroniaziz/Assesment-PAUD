...
<div class="game-container h-screen flex flex-col p-2 md:p-4 relative overflow-hidden safe-area-inset">
    <!-- Elegant Header with Progress -->
        <div class="flex-shrink-0 mb-2 md:mb-3 relative z-10">
            <div class="bg-white/95 backdrop-blur-lg rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-lg border border-gray-200">
                <!-- Mobile Layout -->
                <div class="md:hidden">
                    <div class="flex items-center justify-between mb-2.5 gap-2">
                        <div class="flex items-center gap-2.5 flex-shrink-0">
                            <div class="bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 rounded-lg w-9 h-9 flex items-center justify-center text-white text-sm font-bold shadow-md flex-shrink-0">
                                {{ $progress + 1 }}
                            </div>
