...
<div class="game-container h-screen flex flex-col p-2 md:p-4 relative overflow-hidden safe-area-inset">
    ...
    <div class="flex-1 flex flex-col md:grid md:grid-cols-2 gap-2 md:gap-4 overflow-y-auto relative z-10 min-h-0">
        ...
        <div class="flex flex-col min-h-0 w-full flex-1 md:flex-shrink">
            <div class="bg-white/95 backdrop-blur-lg rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-lg mb-2.5 md:mb-3 flex-shrink-0 border border-gray-200">
            ...
            <div class="grid grid-cols-2 gap-2.5 md:gap-4 flex-1 min-h-0 overflow-y-auto w-full" id="choices-container">
                @foreach($currentQuestion->choices as $index => $choice)
                    <button type="button" 
                            class="choice-button group bg-white rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-lg cursor-pointer border-2 border-gray-200 active:border-purple-400 md:hover:border-purple-400 transform active:scale-[1.02] md:hover:scale-105 transition-all duration-200 relative overflow-hidden flex flex-col w-full min-w-0 touch-manipulation"
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-2 right-2 md:top-2 md:right-2 w-6 h-6 md:w-7 md:h-7 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 md:group-hover:opacity-100 transition-all duration-300 z-10 shadow-lg flex-shrink-0">
                            <i class="fas fa-check text-xs"></i>
                        </div>
                        
                        <!-- Choice Image -->
                        <div class="flex-1 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-lg p-2 md:p-3 mb-2 md:mb-2 border border-gray-100 flex items-center justify-center overflow-hidden md:group-hover:shadow-md transition-shadow duration-300 min-h-0 w-full">
                        ...
                        <div class="text-center flex-shrink-0 mt-auto">
                            <div class="inline-flex items-center justify-center bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 text-white rounded-full w-7 h-7 md:w-8 md:h-8 font-bold text-xs md:text-sm shadow-md md:group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                                {{ $index + 1 }}
                            </div>
                        </div>
                    </button>
