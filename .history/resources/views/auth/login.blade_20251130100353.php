        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative z-10 animate-slide-in-right">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-6 animate-bounce-in">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-2xl shadow-2xl mb-4 transform hover:scale-110 hover:rotate-12 transition-all duration-300 animate-glow-pulse cursor-pointer">
