        ...
        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="block w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:ring-2 transition-all duration-200 {{ $errors->has('email') ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-indigo-500 focus:border-indigo-500' }} bg-gray-50 hover:bg-white hover:border-indigo-300 group"
