        ...
        <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 animate-slide-in-left">
            <div class="relative z-10 max-w-lg">
                ...
                <div class="mt-12 text-center">
                    ...
                    <p class="text-xl text-white/90 leading-relaxed drop-shadow-md animate-scale-in delay-700">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative z-10 animate-slide-in-right">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8 animate-bounce-in">
                    ...
                    <h2 class="text-4xl font-bold text-white mb-2 drop-shadow-lg animate-scale-in delay-200">
                        Selamat Datang Kembali
                    </h2>
                    <p class="text-white/80 text-lg animate-scale-in delay-300">
                ...
                <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-10 space-y-6 border border-white/20 transform hover:shadow-3xl hover:scale-[1.02] transition-all duration-300">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6" id="loginForm">
                        ...
                        <div class="flex items-center justify-between animate-scale-in delay-700">
                        ...
                        <!-- Submit Button -->
                        <div class="pt-2 animate-scale-in delay-800">
                            <button
                                type="submit"
                                id="submitBtn"
