    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 animate-slide-in-left">
            <div class="relative z-10 max-w-lg">
                ...
                <div class="mt-8 flex flex-wrap gap-3 justify-center">
                    <span class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-sm font-medium hover:scale-110 transition-transform duration-200 cursor-default">🎮 Interaktif</span>
                    <span class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-sm font-medium hover:scale-110 transition-transform duration-200 cursor-default">📊 Analitik</span>
                    <span class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-sm font-medium hover:scale-110 transition-transform duration-200 cursor-default">👨‍🏫 Profesional</span>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative z-10 animate-slide-in-right">
            <div class="w-full max-w-md">
                <!-- Login Card -->
                <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-10 space-y-6 border border-white/20 transform hover:shadow-3xl hover:scale-[1.02] transition-all duration-300">
                    <!-- Logo & Welcome Text -->
                    <div class="text-center mb-6">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg mb-4 transform hover:scale-110 hover:rotate-12 transition-all duration-300 cursor-pointer">
        ...
        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="block w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:ring-2 transition-all duration-200 @error('email') border-red-300 focus:ring-red-500 focus:border-red-500 @else border-gray-200 focus:ring-indigo-500 focus:border-indigo-500 @enderror bg-gray-50 hover:bg-white hover:border-indigo-300 group"
        ...
        <!-- Password -->
                        <div>
                            ...
                            name="password"
                                    ...
                                    class="block w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:ring-2 transition-all duration-200 @error('password') border-red-300 focus:ring-red-500 focus:border-red-500 @else border-gray-200 focus:ring-indigo-500 focus:border-indigo-500 @enderror bg-gray-50 hover:bg-white hover:border-indigo-300 group"
            ...
            @endif
                        ...
                        <div class="pt-2">
                            <button
                                type="submit"
                                id="submitBtn"
                                class="group w-full flex justify-center items-center py-4 px-6 border border-transparent rounded-xl shadow-lg text-base font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform hover:scale-[1.02] hover:shadow-xl transition-all duration-200 ease-in-out relative overflow-hidden"
                            >
                                <span class="relative z-10 text-white">Masuk</span>
                                <svg class="ml-3 h-5 w-5 text-white group-hover:translate-x-1 transition-transform duration-200 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
