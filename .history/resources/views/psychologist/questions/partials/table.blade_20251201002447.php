    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold">Informasi Jawaban</h2>
            ...
            <div class="modal-body">
                <div class="row g-5">
                    ...
                    <div class="col-md-6">
                        <div class="card card-flush h-100">
                            ...
                            <div class="card-body">
                                <div class="mb-5">
                                    <label class="form-label fw-bold">Gambar Pilihan</label>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-lg badge-light-primary fs-4 fw-bold px-4 py-3">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        @else
                                            <span class="badge badge-light-secondary fs-7 fw-bold px-3 py-2">
                                                <i class="fas fa-times-circle me-1"></i>Bukan Jawaban Benar
                                            </span>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="mt-5 pt-5 border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <span class="text-gray-600 fw-semibold">Total Skor:</span>
                            <span class="text-primary fw-bold fs-3 ms-2">
