                    ...
                    <div class="col-lg-6">
                        <div class="card card-flush h-100 shadow-sm">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Image-->
                                <div class="mb-7 text-center">
                                    <div class="mx-auto mb-5" style="width: 100%; max-width: 500px; aspect-ratio: 4/3;">
                                        <img src="{{ asset('storage/' . $choice->choice_image_path) }}"
                                             alt="Pilihan {{ $index + 1 }}"
                                             class="w-100 h-100 rounded"
                                             style="object-fit: cover; border: 3px solid #f1f1f2; box-shadow: 0 0.5rem 1rem rgba(0,0,0,0.15);"
                                             onerror="this.src='https://via.placeholder.com/500x375?text=Gambar+Tidak+Ditemukan'; this.onerror=null;">
                                    </div>
                                </div>
                                <!--end::Image-->
                ...
                <div class="card card-flush bg-light-primary mb-0">
                    <div class="card-body py-6">
                        <div class="d-flex flex-stack flex-wrap align-items-center">
                            <div class="d-flex flex-column">
                                <span class="text-gray-600 fw-semibold fs-6 mb-1">Jumlah Jawaban Benar</span>
                                <span class="text-primary fw-bold fs-2">
                                    {{ $question->choices->where('is_correct', true)->count() }} dari {{ $question->choices->count() }} pilihan
                                </span>
                            </div>
