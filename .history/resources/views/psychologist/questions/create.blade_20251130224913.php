                ...
                <div id="choices-container" class="space-y-4">
                    ...
                    <div class="card card-flush mb-5 choice-item">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" name="choices[0][is_correct]" value="1" id="choice_0_correct">
                    ...
                    <div class="card card-flush mb-5 choice-item">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" name="choices[1][is_correct]" value="1" id="choice_1_correct">
