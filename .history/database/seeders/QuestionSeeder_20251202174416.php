...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($aspects as $aspect) {
            ...
            foreach ($questionDirs as $questionDir) {
                ...
                // Hitung skor pilihan: dibagi rata sehingga total = 100
                ...
                for ($i = 0; $i < $choiceCount; $i++) {
                    if ($i < $choiceCount - 1) {
                        ...
                        $scores[$i] = 100 - $sum; // pastikan total tepat 100
                    }
                }
    ...
    /**
     * Copy satu file dari public ke storage disk 'public'.
     */
    private function copyToPublicStorage(string $sourcePath, string $targetRelativePath): void
    {
        try {
            ...
            // Skip jika sudah ada (hindari overwrite)
