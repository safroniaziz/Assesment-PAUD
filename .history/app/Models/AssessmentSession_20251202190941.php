...
class AssessmentSession extends Model
{
    ...
    /**
     * Get maximum possible score (number of questions × max score per question)
     * Max score per question = 40 (highest choice score)
     */
    public function getMaxScoreAttribute(): int
    {
        $totalQuestions = $this->answers()->distinct('question_id')->count('question_id');
        return $totalQuestions * 40; // 40 adalah skor tertinggi per soal
    }
